...
from Zenaku.config import (BANNED_USERS, CLEANMODE_DELETE_MINS,
                    MUSIC_BOT_NAME, OWNER_ID)
from Zenaku.Bgt import get_command
from Zenaku import app
from Zenaku.utils.database import (add_nonadmin_chat,
