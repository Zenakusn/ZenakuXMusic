...
from Zenaku.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
from Zenaku.Bgt import get_command
from Zenaku import app
from Zenaku.core.call import Zenakuh
from Zenaku.misc import db
from Zenaku.utils.database import get_authuser_names, get_cmode
from Zenaku.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Zenaku.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Zenakuh.stop_stream(message.chat.id)
    except:
        pass
