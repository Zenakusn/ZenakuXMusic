...
from Zenaku.config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from Zenaku.Bgt import get_command
from Zenaku import Carbon, YouTube, app
from Zenaku.utils.database import (delete_playlist, get_playlist,
                                       get_playlist_names,
                                       save_playlist)
from Zenaku.utils.decorators.language import language, languageCB
from Zenaku.utils.inline.play import close_keyboard
...
async def add_playlist(client, CallbackQuery, _):
    ...
    try:
        ...
        return await CallbackQuery.message.reply_text(
            text="☘ 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭 𝐀𝐝𝐝𝐞𝐝.\n │\n └𝐑𝐞𝐪𝐮𝐞𝐬𝐭𝐞𝐝 𝐁𝐲 : {0} \n\n 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 [𝐁𝐢𝐤𝐚𝐬𝐡](https://t.me/seriosvs_version20)".format(CallbackQuery.from_user.mention),
